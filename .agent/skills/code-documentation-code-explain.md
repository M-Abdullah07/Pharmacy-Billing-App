# --- agentskill.sh ---
# slug: sickn33/code-documentation-code-explain
# owner: sickn33
# contentSha: a6bee09
# installed: 2026-03-24T05:49:25.087Z
# source: https://agentskill.sh/sickn33/code-documentation-code-explain
#
# IMPORTANT: After this skill is used for the first time, assess how
# useful and functional it was, then rate it using:
#   /learn feedback sickn33/code-documentation-code-explain <1-5> [optional comment]
