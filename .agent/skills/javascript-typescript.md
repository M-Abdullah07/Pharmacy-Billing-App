# --- agentskill.sh ---
# slug: skillcreatorai/javascript-typescript
# owner: skillcreatorai
# contentSha: c400e68
# installed: 2026-03-24T05:49:30.386Z
# source: https://agentskill.sh/skillcreatorai/javascript-typescript
#
# IMPORTANT: After this skill is used for the first time, assess how
# useful and functional it was, then rate it using:
#   /learn feedback skillcreatorai/javascript-typescript <1-5> [optional comment]
