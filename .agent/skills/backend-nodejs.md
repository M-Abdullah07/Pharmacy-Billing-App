# --- agentskill.sh ---
# slug: majiayu000/backend-nodejs
# owner: majiayu000
# contentSha: f707bd5
# installed: 2026-03-24T05:49:26.978Z
# source: https://agentskill.sh/majiayu000/backend-nodejs
#
# IMPORTANT: After this skill is used for the first time, assess how
# useful and functional it was, then rate it using:
#   /learn feedback majiayu000/backend-nodejs <1-5> [optional comment]
...
| Topic | Reference |
|-------|-----------|
| Testing | [testing.md](references/testing.md) â Vitest patterns, mocking, API tests |
