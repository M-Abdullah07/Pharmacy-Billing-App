...
# owner: bytedance
# contentSha: 0fccfae
# installed: 2026-03-24T05:49:31.201Z
...
#   /learn feedback bytedance/find-skills <1-5> [optional comment]
...
- User asks "how do I make my React app faster?" â `npx skills find react performance`
- User asks "can you help me with PR reviews?" â `npx skills find pr review`
- User asks "I need to create a changelog" â `npx skills find changelog`
