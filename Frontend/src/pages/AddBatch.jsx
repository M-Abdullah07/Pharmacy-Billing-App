    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.error?.includes('already exists') || result.error?.includes('batch_number')) {
          setFieldErrors({
            batch_number: 'This batch number already exists for this product. Please verify.',
          });
        } else {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            Add stock batches with MRP, expiry and DRAP compliance tracking
          </p>
        </div>
        <button
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <div className="flex items-center justify-between mb-5">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">
                Fields marked <span className="text-red-500">*</span> are required. MRP is
                DRAP-mandated and must match the printed pack price.
              </p>
            </div>
            <button
              onClick={() => {
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            <div>
              ...
              <select
                ...
                className={selectCls('product_id')}
              >
              ...
              {fieldErrors.product_id && (
                <p className="text-red-500 text-xs mt-1">{fieldErrors.product_id}</p>
              )}
            </div>
            ...
            <div>
              ...
              <select
                ...
                className={selectCls('supplier_id')}
              >
              ...
              {fieldErrors.supplier_id && (
                <p className="text-red-500 text-xs mt-1">{fieldErrors.supplier_id}</p>
              )}
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              ...
              />
              {fieldErrors.manufacturing_date && (
                <p className="text-red-500 text-xs mt-1">{fieldErrors.manufacturing_date}</p>
              )}
            </div>
            ...
            <div>
              ...
              {fieldErrors.expiry_date && (
                <p className="text-red-500 text-xs mt-1">{fieldErrors.expiry_date}</p>
              )}
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            ...
            <div>
              ...
              />
              {fieldErrors.purchase_cost_per_unit && (
                <p className="text-red-500 text-xs mt-1">{fieldErrors.purchase_cost_per_unit}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {fieldErrors.quantity_received && (
                <p className="text-red-500 text-xs mt-1">{fieldErrors.quantity_received}</p>
              )}
            </div>
          </div>
          ...
          <div className="flex items-start gap-2 p-3 bg-blue-50 border border-blue-100 rounded-lg mb-6">
            ...
            <p className="text-xs text-blue-700">
              ...
              <span className="font-medium"> quantity_available</span> is managed automatically by
              the database.
            </p>
          </div>
